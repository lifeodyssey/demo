...
dependencies {
    ...
    testImplementation("io.rest-assured:rest-assured-common:5.2.1")
    testImplementation("io.rest-assured:spring-mock-mvc:5.2.1")


//    implementation(project("${project.rootDir}/model"))
//    contracts(project(":model"))
